...
import report.ExtentReportConfig;
...
public class TestListner extends MobileWrapper implements ITestListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        WebDriver webDriver = ((MobileWrapper) TestListener).getDriver();
        if (webDriver != null)
        {
